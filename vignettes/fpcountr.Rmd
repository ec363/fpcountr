...
```{r warning=FALSE}
parsed_data_spectrum <- parse_magellan_spectrum(data_csv = file.path(data_folder, paste0(raw_data_spectrum, ".csv")),
...
processed_data_spectrum_t5n15pi <- process_absorbance_spectrum(
...
```{r warning=FALSE}
parsed_data <- parse_magellan(data_csv = file.path(data_folder, paste0(raw_data_fluor, ".csv")),
...
```{r}
parsed_data <- parse_magellan(data_csv = file.path(data_folder, paste0(raw_data, ".csv")),
